...
import SellerCreateCategory from './pages/Seller/SellerCreateCategory';
    ...
    <>
      <Routes>
        ...
        <Route path="/dashboard" element={<SellerRoute />}>
          ...
          <Route path="seller/create-category" element={<SellerCreateCategory />} />
          <Route path="seller/create-product" element={<SellerCreateProduct />} />
          <Route path="seller/product/:slug" element={<SellerUpdateProduct />} />
